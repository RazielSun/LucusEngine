...
{
	auto myApplicationSource = ref new MyApplicationSource();
	CoreApplication::Run(myApplicationSource);
	return 0;
}

IFrameworkView^ MyApplicationSource::CreateView()
{
	return ref new App();
}
